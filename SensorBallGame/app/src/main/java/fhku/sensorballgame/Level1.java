...
/**
 * Created by tobibeck on 10.11.16.
 */
...
public class Level1 extends Level {
    ...
    public void onDraw(Canvas canvas) {
        ...
        //EndPoint
        canvas.drawCircle(width-this.toPx(45),width
                -this.toPx(45),this.toPx(30),paint);



        paint.setStrokeWidth(this.toPx(10));
        canvas.drawLine(this.toPx(45),this.toPx(45),width-this.toPx(40),this.toPx(45),paint);
        canvas.drawLine(width-this.toPx(45),this.toPx(45),width-this.toPx(45),width-this.toPx(45),paint);

        //Goal
        canvas.drawCircle(width-this.toPx(45),width
                -this.toPx(45),this.toPx(15),goal);
    ...
    public boolean isOnPath(int cx,int cy,int lx,int ly){
       /* if((x>this.toPx(15)&& x<(width-this.toPx(20)))&&(y>this.toPx((15)))){
        ...
        //Line Left to right
        if(cy>this.toPx(40) && cy < this.toPx(50) && cx < width-this.toPx(40)){
            return true;
        }
        ...
        //Finish Circle
        if((cx - (width-this.toPx(45)))*(cx - (width-this.toPx(45))) + (cy - (width-this.toPx(45)))*(cy - (width-this.toPx(45))) <= this.toPx(30)*this.toPx(30)){
            return true;
        }
    ...
    public boolean isInGoal(int cx,int cy,int lx,int ly){
        if((cx - (width-this.toPx(45)))*(cx - (width-this.toPx(45))) + (cy - (width-this.toPx(45)))*(cy - (width-this.toPx(45))) <= this.toPx(15)*this.toPx(15)){
            return true;
        }
